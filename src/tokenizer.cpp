...
bool Tokenizer::isKeyword(const std::string &word) const {
  static const std::map<std::string, TokenType> keywords = {
      ...
      {"ON", TokenType::ON},           {"AT", TokenType::AT},
      {"CLR", TokenType::CLR},         {"HOME", TokenType::HOME},
      ...
      {"VLIN", TokenType::VLIN},       {"HPLOT", TokenType::HPLOT},
      {"XDRAW", TokenType::XDRAW},     {"DRAW", TokenType::DRAW},
      {"MOVE", TokenType::MOVE},       {"ROTATE", TokenType::ROTATE},
      {"SCALE", TokenType::SCALE},     {"SIN", TokenType::SIN},
      ...
      {"SPEED", TokenType::SPEED},     {"PR", TokenType::PR},
      {"IN", TokenType::IN},           {"WHILE", TokenType::WHILE},
      {"WEND", TokenType::WEND},       {"POP", TokenType::POP},
      {"WAIT", TokenType::WAIT},       {"HIMEM", TokenType::HIMEM},
      {"LOMEM", TokenType::LOMEM},     {"SCRN", TokenType::SCRN},
      {"USR", TokenType::USR}};
