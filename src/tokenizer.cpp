...
bool Tokenizer::isKeyword(const std::string &word) const {
  static const std::map<std::string, TokenType> keywords = {
      ...
      {"HGR", TokenType::HGR},        {"HGR2", TokenType::HGR2},
      {"HCOLOR=", TokenType::HCOLOR}, {"CALL", TokenType::CALL},
      {"PEEK", TokenType::PEEK},      {"POKE", TokenType::POKE},
      {"GET", TokenType::GET},        {"HTAB", TokenType::HTAB},
      {"VTAB", TokenType::VTAB},      {"INVERSE", TokenType::INVERSE},
      {"NORMAL", TokenType::NORMAL},  {"FLASH", TokenType::FLASH},
      {"STOP", TokenType::STOP},      {"PLOT", TokenType::PLOT},
      {"HLIN", TokenType::HLIN},      {"VLIN", TokenType::VLIN},
      {"SIN", TokenType::SIN},        {"COS", TokenType::COS},
      {"TAN", TokenType::TAN},        {"ATN", TokenType::ATN},
      {"EXP", TokenType::EXP},        {"LOG", TokenType::LOG},
      {"SQR", TokenType::SQR},        {"ABS", TokenType::ABS},
      {"INT", TokenType::INT},        {"SGN", TokenType::SGN},
      {"RND", TokenType::RND},        {"LEN", TokenType::LEN},
      {"VAL", TokenType::VAL},        {"ASC", TokenType::ASC},
      {"CHR$", TokenType::CHR},       {"LEFT$", TokenType::LEFT},
      {"RIGHT$", TokenType::RIGHT},   {"MID$", TokenType::MID},
      {"STR$", TokenType::STR},       {"TAB", TokenType::TAB},
      {"SPC", TokenType::SPC},        {"POS", TokenType::POS},
